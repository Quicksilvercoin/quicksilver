...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 20 ; // 40 days
...
const string strMessageMagic = "quicksilver Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    int64_t nSubsidy = 0 * COIN;
        ...
        {
            nSubsidy = 5000000 * COIN; // 5 million coins for ico
        }
...
const int DAILY_BLOCKCOUNT =  1800;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "quicksilver", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "CNN news: Russia taking jabs at Sweden";
        CTransaction txNew;
        txNew.nTime = 1414187923;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1414187923;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1101205;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xe00b77078accf276eb79f07f754d2c25af56fb3a28689b324aa0ce4bc66ccb0c"));
        block.print();
